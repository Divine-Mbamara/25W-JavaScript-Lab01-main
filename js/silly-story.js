...
function result() {
    ...
    var newStory = storyText.replace(":insertx:", xItem).replace(":inserty:", yItem).replace(":insertz:", zItem).replace(":insertx:", xItem);
